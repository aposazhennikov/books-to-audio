...
- **Old direct-runner docs/scripts are missing**: this is expected. The TTS contract is v2-only; generate/use `chunks_manifest_v2.json` and synthesize through ComfyUI.
