...
from book_normalizer.cli_production import (
    analyze_characters_command,
    audio_qa_command,
    cast_voices_command,
    package_audiobook_command,
    production_preflight_command,
    production_qa_command,
    score_director_command,
)
...
for _production_command in (
    ...
    main.add_command(_production_command)
