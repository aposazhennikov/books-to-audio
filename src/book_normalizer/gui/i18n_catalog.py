...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "auto.production": {
        "en": "Automatic build: final QA and audiobook package.",
    ...
    "auto.quality": {
        "en": "Automatic build: running final audio QA.",
    ...
    "auto.cancelled": {
        "en": "Automatic build cancelled.",
        "ru": "\u0410\u0432\u0442\u043e\u0441\u0431\u043e\u0440\u043a\u0430 \u043e\u0442\u043c\u0435\u043d\u0435\u043d\u0430.",
        "zh": "\u81ea\u52a8\u751f\u6210\u5df2\u53d6\u6d88\u3002",
        "kk": "\u0410\u0432\u0442\u043e\u0436\u0438\u043d\u0430\u0443 \u0431\u0430\u0441 \u0442\u0430\u0440\u0442\u044b\u043b\u0434\u044b.",
        "uz": "Avtoyig'ish bekor qilindi.",
    },
    "auto.cache_dialog_title": {
        "en": "Automatic build cache",
        "ru": "\u041a\u0435\u0448 \u0430\u0432\u0442\u043e\u0441\u0431\u043e\u0440\u043a\u0438",
        "zh": "\u81ea\u52a8\u751f\u6210\u7f13\u5b58",
        "kk": "\u0410\u0432\u0442\u043e\u0436\u0438\u043d\u0430\u0443 \u043a\u044d\u0448\u0456",
        "uz": "Avtoyig'ish keshi",
    },
    "auto.cache_dialog_text": {
        "en": "Use cached completed steps for “{name}”?",
    ...
    "auto.cache_dialog_informative": {
        "en": "Restore from cache reuses completed normalization, roles, and prepared chunks when available. Start from scratch ignores those caches and processes the book again.",
        "ru": "\u0412\u043e\u0441\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u0438\u0435 \u0438\u0437 \u043a\u0435\u0448\u0430 \u043f\u0435\u0440\u0435\u0438\u0441\u043f\u043e\u043b\u044c\u0437\u0443\u0435\u0442 \u0433\u043e\u0442\u043e\u0432\u0443\u044e \u043d\u043e\u0440\u043c\u0430\u043b\u0438\u0437\u0430\u0446\u0438\u044e, \u0440\u043e\u043b\u0438 \u0438 \u0447\u0430\u043d\u043a\u0438, \u0435\u0441\u043b\u0438 \u043e\u043d\u0438 \u0435\u0441\u0442\u044c. \u0417\u0430\u043f\u0443\u0441\u043a \u0441 \u043d\u0443\u043b\u044f \u0438\u0433\u043d\u043e\u0440\u0438\u0440\u0443\u0435\u0442 \u044d\u0442\u043e\u0442 \u043a\u0435\u0448 \u0438 \u043e\u0431\u0440\u0430\u0431\u0430\u0442\u044b\u0432\u0430\u0435\u0442 \u043a\u043d\u0438\u0433\u0443 \u0437\u0430\u043d\u043e\u0432\u043e.",
        "zh": "\u4ece\u7f13\u5b58\u6062\u590d\u4f1a\u5c3d\u91cf\u590d\u7528\u5df2\u5b8c\u6210\u7684\u89c4\u8303\u5316\u3001\u89d2\u8272\u548c\u5206\u5757\u3002\u4ece\u5934\u5f00\u59cb\u4f1a\u5ffd\u7565\u8fd9\u4e9b\u7f13\u5b58\u5e76\u91cd\u65b0\u5904\u7406\u4e66\u7a3f\u3002",
        "kk": "\u041a\u044d\u0448\u0442\u0435\u043d \u049b\u0430\u043b\u043f\u044b\u043d\u0430 \u043a\u0435\u043b\u0442\u0456\u0440\u0443 \u0434\u0430\u0439\u044b\u043d \u043d\u043e\u0440\u043c\u0430\u043b\u0434\u0430\u0443\u0434\u044b, \u0440\u04e9\u043b\u0434\u0435\u0440\u0434\u0456 \u0436\u04d9\u043d\u0435 \u0447\u0430\u043d\u043a\u0442\u0430\u0440\u0434\u044b \u049b\u0430\u0439\u0442\u0430 \u049b\u043e\u043b\u0434\u0430\u043d\u0430\u0434\u044b. \u0411\u0430\u0441\u044b\u043d\u0430\u043d \u0431\u0430\u0441\u0442\u0430\u0443 \u0431\u04b1\u043b \u043a\u044d\u0448\u0442\u0456 \u0435\u043b\u0435\u043c\u0435\u0439, \u043a\u0456\u0442\u0430\u043f\u0442\u044b \u049b\u0430\u0439\u0442\u0430 \u04e9\u04a3\u0434\u0435\u0439\u0434\u0456.",
        "uz": "Keshdan tiklash mavjud bo'lsa, tugallangan normallashtirish, rollar va bo'laklarni qayta ishlatadi. Boshidan boshlash bu keshlarni e'tiborsiz qoldirib, kitobni qayta ishlaydi.",
    },
    "auto.cache_restore_button": {
    ...
    "roles.special_sections": {
        "en": "Book has annotations/epigraphs",
        "ru": "\u0412 \u043a\u043d\u0438\u0433\u0435 \u0435\u0441\u0442\u044c \u0430\u043d\u043d\u043e\u0442\u0430\u0446\u0438\u0438/\u044d\u043f\u0438\u0433\u0440\u0430\u0444\u044b",
        "zh": "\u4e66\u4e2d\u6709\u6ce8\u91ca/\u9898\u8bcd",
        "kk": "\u041a\u0456\u0442\u0430\u043f\u0442\u0430 \u0430\u043d\u043d\u043e\u0442\u0430\u0446\u0438\u044f/\u044d\u043f\u0438\u0433\u0440\u0430\u0444 \u0431\u0430\u0440",
        "uz": "Kitobda annotatsiya/epigraf bor",
    },
    "roles.special_sections_tip": {
        "en": "Marks short annotation or epigraph blocks near chapter titles for a separate narration voice.",
        "ru": "\u041f\u043e\u043c\u0435\u0447\u0430\u0435\u0442 \u043a\u043e\u0440\u043e\u0442\u043a\u0438\u0435 \u0430\u043d\u043d\u043e\u0442\u0430\u0446\u0438\u0438 \u0438\u043b\u0438 \u044d\u043f\u0438\u0433\u0440\u0430\u0444\u044b \u0440\u044f\u0434\u043e\u043c \u0441 \u0437\u0430\u0433\u043e\u043b\u043e\u0432\u043a\u0430\u043c\u0438 \u0433\u043b\u0430\u0432 \u0434\u043b\u044f \u043e\u0442\u0434\u0435\u043b\u044c\u043d\u043e\u0433\u043e \u0433\u043e\u043b\u043e\u0441\u0430.",
        "zh": "\u5c06\u7ae0\u8282\u6807\u9898\u9644\u8fd1\u7684\u77ed\u6ce8\u91ca\u6216\u9898\u8bcd\u6807\u8bb0\u4e3a\u5355\u72ec\u7684\u53d9\u8ff0\u58f0\u97f3\u3002",
        "kk": "\u0422\u0430\u0440\u0430\u0443 \u0430\u0442\u0430\u0443\u044b \u0436\u0430\u043d\u044b\u043d\u0434\u0430\u0493\u044b \u049b\u044b\u0441\u049b\u0430 \u0430\u043d\u043d\u043e\u0442\u0430\u0446\u0438\u044f/\u044d\u043f\u0438\u0433\u0440\u0430\u0444\u0442\u044b \u0431\u04e9\u043b\u0435\u043a \u0434\u0430\u0443\u044b\u0441\u049b\u0430 \u0431\u0435\u043b\u0433\u0456\u043b\u0435\u0439\u0434\u0456.",
        "uz": "Bob sarlavhalari yaqinidagi qisqa annotatsiya yoki epigraflarni alohida ovoz uchun belgilaydi.",
    },
    "roles.empty": {
    ...
    "voice.quick_intonation_tip": {
        "en": "Choose an intonation and apply it to visible rows.",
    ...
    "voice.apply_intonation_all_tip": {
        "en": "Apply the selected intonation to all visible rows.",
        "ru": "Применить выбранную интонацию ко всем видимым строкам.",
        "zh": "将所选语调应用到所有可见行。",
        "kk": "Таңдалған интонацияны барлық көрінетін жолға қолдану.",
        "uz": "Tanlangan intonatsiyani barcha ko'rinadigan qatorlarga qo'llash.",
    },
    "voice.apply_intonation_dialogue_tip": {
        "en": "Apply the selected intonation to dialogue rows only.",
        "ru": "Применить выбранную интонацию только к репликам.",
        "zh": "仅将所选语调应用到对话行。",
        "kk": "Таңдалған интонацияны тек диалог жолдарына қолдану.",
        "uz": "Tanlangan intonatsiyani faqat dialog qatorlariga qo'llash.",
    },
    "voice.apply_intonation_narrator_tip": {
        "en": "Apply the selected intonation to narrator rows only.",
        "ru": "Применить выбранную интонацию только к авторскому тексту.",
        "zh": "仅将所选语调应用到旁白行。",
        "kk": "Таңдалған интонацияны тек автор мәтініне қолдану.",
        "uz": "Tanlangan intonatsiyani faqat muallif qatorlariga qo'llash.",
    },
    ...
    "voice.play_audio_unavailable_missing": {
        "en": "Audio is not available yet. Run synthesis first, then this chunk can be played.",
        "ru": "Аудио ещё не создано. Сначала запустите синтез, затем этот чанк можно будет прослушать.",
        "zh": "音频尚不可用。请先运行合成，然后即可播放此分块。",
        "kk": "Аудио әлі дайын емес. Алдымен синтезді іске қосыңыз, содан кейін бұл чанкті тыңдай аласыз.",
        "uz": "Audio hali tayyor emas. Avval sintezni ishga tushiring, keyin bu bo'lakni tinglash mumkin.",
    },
    "voice.play_audio_unavailable_not_found": {
        "en": "The manifest points to an audio file, but the file is missing on disk.",
        "ru": "В manifest указан аудиофайл, но на диске он не найден.",
        "zh": "Manifest 指向音频文件，但磁盘上找不到该文件。",
        "kk": "Manifest аудио файлды көрсетеді, бірақ ол дискіде жоқ.",
        "uz": "Manifest audio faylga ishora qiladi, lekin fayl diskda topilmadi.",
    },
    "voice.play_audio_unavailable_player": {
        "en": "Audio playback is unavailable in this PyQt installation.",
        "ru": "В этой установке PyQt недоступно воспроизведение аудио.",
        "zh": "此 PyQt 安装中无法播放音频。",
        "kk": "Бұл PyQt орнатылымында аудио ойнату қолжетімсіз.",
        "uz": "Ushbu PyQt o'rnatilishida audio ijro etish mavjud emas.",
    },
    "voice.mark_retry": {"en": "Retry", "ru": "Повтор"},
    "voice.mark_retry_unavailable": {
        "en": "Manual retry is available after loading a v2 synthesis manifest.",
        "ru": "Ручной повтор доступен после загрузки v2 manifest синтеза.",
        "zh": "加载 v2 合成 manifest 后可使用手动重试。",
        "kk": "Қолмен қайталау v2 синтез manifest жүктелгеннен кейін қолжетімді.",
        "uz": "Qo'lda qayta urinish v2 sintez manifesti yuklangandan keyin mavjud.",
    },
    ...
    "voice.special_sections": {
        "en": "Annotations/epigraphs",
        "ru": "Аннотации/эпиграфы",
        "zh": "注释/题词",
        "kk": "Аннотация/эпиграф",
        "uz": "Annotatsiya/epigraf",
    },
    "voice.special_sections_tip": {
        "en": "Mark short annotation or epigraph blocks near chapter titles for a separate voice.",
        "ru": "Помечает короткие аннотации или эпиграфы рядом с заголовками глав для отдельного голоса.",
        "zh": "将章节标题附近的短注释或题词标记为单独的声音。",
        "kk": "Тарау атауы жанындағы қысқа аннотация немесе эпиграфты бөлек дауысқа белгілейді.",
        "uz": "Bob sarlavhalari yaqinidagi qisqa annotatsiya yoki epigraflarni alohida ovoz uchun belgilaydi.",
    },
    ...
    "synth.resume_note": {
        ...
        "ru": "Автоматически: чанки с synthesized=true и существующим audio_file пропускаются. Для QA-повторов используйте пересинтез ошибок/предупреждений.",
        "zh": "自动：跳过 synthesized=true 且已有 audio_file 的块。QA 重试请使用重新合成失败/警告。",
        "kk": "Автоматты түрде: synthesized=true және audio_file бар бөліктер өткізіледі. QA қайталаулары үшін сәтсіз/ескерту бөліктерін қайта синтездеуді қолданыңыз.",
        "uz": "Avtomatik: synthesized=true va mavjud audio_file bo'lgan bo'laklar o'tkazib yuboriladi. QA qayta urinishlari uchun xato/ogohlantirish bo'laklarini qayta sintez qiling.",
    },
    "synth.resume_check": {
    ...
    "asm.production_gate_no_chunks": {
        ...
        "uz": "Paket bloklangan: manifestda production bo'laklari yo'q.",
    },
    "asm.production_gate_audio_not_synthesized": {
        "en": "Package locked: synthesize all included chunks first.",
        "ru": "Пакет заблокирован: сначала синтезируйте все включённые чанки.",
        "zh": "打包已锁定：请先合成所有包含的块。",
        "kk": "Пакет бұғатталған: алдымен барлық қосылған бөліктерді синтездеңіз.",
        "uz": "Paket bloklangan: avval barcha kiritilgan bo'laklarni sintez qiling.",
    },
    "asm.production_gate_audio_missing": {
        "en": "Package locked: synthesized chunk audio is missing on disk.",
        "ru": "Пакет заблокирован: аудио синтезированного чанка отсутствует на диске.",
        "zh": "打包已锁定：磁盘上缺少已合成块的音频。",
        "kk": "Пакет бұғатталған: синтезделген бөліктің аудиосы дискте жоқ.",
        "uz": "Paket bloklangan: sintez qilingan bo'lak audiosi diskda yo'q.",
    },
    "asm.production_gate_asr": {
        "en": "Package locked: ASR QA must pass for every included chunk.",
        "ru": "Пакет заблокирован: ASR QA должен пройти для каждого включённого чанка.",
        "zh": "打包已锁定：每个包含的块都必须通过 ASR QA。",
        "kk": "Пакет бұғатталған: әр қосылған бөлік ASR QA тексеруінен өтуі керек.",
        "uz": "Paket bloklangan: har bir kiritilgan bo'lak ASR QA dan o'tishi kerak.",
    },
    "asm.production_gate_qa": {
        "en": "Package locked: run production preflight and resolve review/resynthesis items.",
        "ru": "Пакет заблокирован: запустите production preflight и закройте review/пересинтез.",
        "zh": "打包已锁定：运行生产预检并处理复核/重合成项。",
        "kk": "Пакет бұғатталған: production preflight іске қосып, review/қайта синтез тармақтарын жабыңыз.",
        "uz": "Paket bloklangan: production preflight ishga tushiring va review/qayta sintez bandlarini yoping.",
    },
    "asm.production_gate_not_assembled": {
        "en": "Package locked: assemble chapter audio before packaging.",
        "ru": "Пакет заблокирован: перед упаковкой соберите аудио глав.",
    ...
    "asm.production_gate_ready": {
        ...
        "kk": "Пакет дайын: ASR және production QA өтті, review таза, тарау аудиосы жиналды.",
        "uz": "Paket tayyor: ASR va production QA o'tdi, review toza, bob audiosi yig'ilgan.",
    },
