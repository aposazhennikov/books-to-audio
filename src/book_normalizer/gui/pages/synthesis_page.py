...
from book_normalizer.gui.pages.synthesis_asr_mixin import SynthesisAsrMixin
from book_normalizer.gui.pages.synthesis_callbacks_mixin import SynthesisCallbacksMixin
from book_normalizer.gui.pages.synthesis_clone_voice import _CloneVoiceRow
from book_normalizer.gui.pages.synthesis_manifest import (
    _build_test_manifest_chunks as _build_test_manifest_chunks,
)
from book_normalizer.gui.pages.synthesis_manifest import (
    _iter_manifest_chunks as _iter_manifest_chunks,
)
from book_normalizer.gui.pages.synthesis_manifest import (
    _merge_manifest_chunk_with_next as _merge_manifest_chunk_with_next,
)
from book_normalizer.gui.pages.synthesis_manifest import (
    _role_for_voice_id as _role_for_voice_id,
)
from book_normalizer.gui.pages.synthesis_manifest import (
    _shorten_test_fragment as _shorten_test_fragment,
)
from book_normalizer.gui.pages.synthesis_manifest import (
    _split_manifest_chunk_text as _split_manifest_chunk_text,
)
from book_normalizer.gui.pages.synthesis_manifest import (
    _test_manifest_chunk_from_chunk as _test_manifest_chunk_from_chunk,
)
from book_normalizer.gui.pages.synthesis_manifest import (
    _test_manifest_chunk_from_text as _test_manifest_chunk_from_text,
)
from book_normalizer.gui.pages.synthesis_manifest import (
    _update_manifest_chunk_text as _update_manifest_chunk_text,
)
from book_normalizer.gui.pages.synthesis_manifest_mixin import SynthesisManifestMixin
from book_normalizer.gui.pages.synthesis_run_mixin import SynthesisRunMixin
...
class SynthesisPage(
    SynthesisRunMixin,
    SynthesisAsrMixin,
    SynthesisCallbacksMixin,
    SynthesisManifestMixin,
    QWidget,
):
    ...
    def _role_mapping_label(self, key: str, count: int = 0) -> str:
        ...
        if key.startswith("speaker:"):
            ...
            label = {
                ...
                "epigraph": t("voice.role_epigraph"),
    ...
    # Manifest, QA dashboard, and preview editing live in SynthesisManifestMixin.
