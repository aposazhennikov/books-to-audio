...
class TestDialogueDetector:
    ...
    def test_dialogue_remark_continuation(self) -> None:
        text = "\u2014 \u0414\u043e\u0431\u0440\u043e\u0435 \u0443\u0442\u0440\u043e, \u2014 \u0441\u043a\u0430\u0437\u0430\u043b\u0430 \u043e\u043d\u0430, \u2014 \u043a\u0430\u043a \u0434\u0435\u043b\u0430?"
        chapter = _make_chapter(text)
        result = self.detector.detect_chapter(chapter)
        lines = result.paragraphs[0].lines
        dialogue_parts = [l for l in lines if l.is_dialogue]
        narrator_parts = [l for l in lines if not l.is_dialogue]
    ...
    def test_quoted_speech_in_narration(self) -> None:
        text = "\u041e\u043d \u043f\u0440\u043e\u0448\u0435\u043f\u0442\u0430\u043b \u00ab\u043f\u043e\u043c\u043e\u0433\u0438\u0442\u0435\u00bb \u0438 \u0437\u0430\u043c\u043e\u043b\u0447\u0430\u043b."
        chapter = _make_chapter(text)
        result = self.detector.detect_chapter(chapter)
        lines = result.paragraphs[0].lines
        has_dialogue = any(l.is_dialogue for l in lines)
        assert has_dialogue
    ...
    def test_detect_book(self) -> None:
        ch1 = _make_chapter("\u0422\u0435\u043a\u0441\u0442 \u043f\u0435\u0440\u0432\u043e\u0439 \u0433\u043b\u0430\u0432\u044b.", index=0)
        ch2 = _make_chapter("\u2014 \u0414\u0438\u0430\u043b\u043e\u0433 \u0432\u0442\u043e\u0440\u043e\u0439 \u0433\u043b\u0430\u0432\u044b!", index=1)
    ...
    def test_multiple_attribution_verbs(self) -> None:
        for verb in ["\u043e\u0442\u0432\u0435\u0442\u0438\u043b", "\u0441\u043f\u0440\u043e\u0441\u0438\u043b\u0430", "\u043a\u0440\u0438\u043a\u043d\u0443\u043b", "\u043f\u0440\u043e\u0448\u0435\u043f\u0442\u0430\u043b\u0430"]:
            text = f"\u2014 \u0422\u0435\u043a\u0441\u0442, \u2014 {verb} \u043e\u043d."
            chapter = _make_chapter(text)
            result = self.detector.detect_chapter(chapter)
            lines = result.paragraphs[0].lines
            narrator_lines = [l for l in lines if not l.is_dialogue]
